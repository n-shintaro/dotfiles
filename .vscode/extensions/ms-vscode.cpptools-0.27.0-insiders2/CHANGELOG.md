...
* Fix `browsePath` null reference that can occur with some configuration providers. [PR [#5055](https://github.com/Microsoft/vscode-cpptools/issues/5055)](https://github.com/microsoft/vscode-cpptools/pull/5055)
