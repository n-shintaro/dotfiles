...
class PreviewManager {
    ...
    warnIfOutdatedPythonVersion(pythonPath) {
        python_shell_1.PythonShell.getVersion(`"${pythonPath}"`).then((out) => {
            var _a, _b, _c, _d;
            if (((_a = out.stdout) === null || _a === void 0 ? void 0 : _a.includes("Python 3.4")) || ((_b = out.stderr) === null || _b === void 0 ? void 0 : _b.includes("Python 3.4"))) {
            ...
            if (((_c = out.stdout) === null || _c === void 0 ? void 0 : _c.includes("Python 2.")) || ((_d = out.stderr) === null || _d === void 0 ? void 0 : _d.includes("Python 2."))) {
